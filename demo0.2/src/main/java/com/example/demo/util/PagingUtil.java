...
public class PagingUtil {
	...
	public boolean setCalcForPaging(Integer objectCountTotal) {
		...
		try {
			...
			System.out.println("tmpPageNumStart : " + tmpPageNumStart);
			...
			System.out.println("pageNumCountTotal : " + pageNumCountTotal);
			System.out.println("tmpPageNumEnd : " + tmpPageNumEnd);
